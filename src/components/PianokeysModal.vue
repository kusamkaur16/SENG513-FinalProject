<template>
<!-- grabbed from https://codepen.io/zastrow/pen/oDBki -->
<ul class="set">
...
//  border: 1px solid #160801;
 ...
 box-shadow: 0 0 50px rgba(59, 206, 172, 0.5) inset, 0 1px rgba(212, 152, 125, 0.2) inset, 0 5px 15px rgba(0, 0, 0, 0.5);
